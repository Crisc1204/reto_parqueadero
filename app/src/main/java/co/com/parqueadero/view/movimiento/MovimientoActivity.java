package co.com.parqueadero.view.movimiento;
...
import co.com.parqueadero.utilities.DateUtil;
        ...
        builder.setMessage(R.string.confirmDialogMessage)
                ...
                .setPositiveButton(R.string.confirmDelete, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        Toast.makeText(getApplicationContext(), R.string.salida_exitosa, Toast.LENGTH_SHORT).show();
                        hideComponents();
                        txtPlaca.setText("");
                    }
                })
